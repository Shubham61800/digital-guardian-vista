...
const Navbar = () => {
  ...
  return <nav className="fixed top-0 left-0 w-full bg-white/90 backdrop-blur-sm z-50 shadow-sm">
      <div className="container mx-auto px-20 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="md:hidden flex">
            <Button variant="ghost" size="icon" className="text-gray-700" onClick={() => setIsMenuOpen(!isMenuOpen)}>
        ...
        {/* Mobile Navigation */}
        {isMenuOpen && <div className="md:hidden mt-4 py-4 bg-white rounded-lg shadow-md">
            <div className="flex flex-col space-y-3 px-4">
              ...
              <Link to="/blog" className="text-gray-700 hover:text-primary-500 transition-colors py-2">
                Blog
              </Link>
