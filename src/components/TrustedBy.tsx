...
const TrustedBy = () => {
  ...
  return (
    <section ref={sectionRef} className="py-16 border-y border-gray-100">
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-wrap justify-center items-center gap-x-16 gap-y-10">
          {logos.map((logo, index) => (
            ...
            >
              <div className="text-black/50 font-bold text-xl tracking-tight hover:text-black transition-colors duration-300">
                {logo.logo}
              </div>
            </div>
          ))}
