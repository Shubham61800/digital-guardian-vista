...
const About = () => {
  ...
  const values = [
    {
      ...
      description: "Every decision we make is guided by our commitment to maximum security and protection."
    },
    {
      icon: Users,
      title: "Client Success",
      description: "Your success is our success. We're dedicated to helping your business thrive securely."
    },
    {
      icon: Award,
      title: "Excellence",
      description: "We maintain the highest standards in cybersecurity solutions and customer service."
    },
    {
      icon: Target,
      title: "Innovation",
      description: "Staying ahead of threats with cutting-edge technology and proactive solutions."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="pt-24 pb-16 shuttle-gradient relative overflow-hidden">
        ...
        <div className="container mx-auto px-20 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
              We're a team of cybersecurity experts dedicated to protecting businesses 
              from evolving digital threats with innovative, reliable solutions.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button className="bg-black hover:bg-gray-800 text-white px-8 py-3 button-glow">
                Our Story
        ...
        <div className="container mx-auto px-20">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <Card key={index} className="text-center p-6 hover-lift frosted-glass border-0">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                Founded in 2018 by a team of cybersecurity veterans, Softwaroid emerged from a simple belief: 
                every business deserves enterprise-grade security, regardless of size.
              </p>
            </div>
            
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <h3 className="text-2xl font-semibold text-black mb-4">From Vision to Reality</h3>
                <p className="text-gray-600 mb-6 leading-relaxed">
                  What started as a small team of passionate security experts has grown into a 
                  trusted partner for over 500 businesses worldwide. We've prevented countless 
                  cyber attacks and helped organizations build robust security frameworks.
                </p>
                <p className="text-gray-600 leading-relaxed">
                  Today, we continue to innovate and adapt to the ever-changing threat landscape, 
                  ensuring our clients stay protected against emerging cybersecurity challenges.
                </p>
              </div>
        ...
        <div className="container mx-auto px-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              <Card key={index} className="p-6 text-center hover-lift border-0 bg-white/70 backdrop-blur-sm">
                <CardContent className="p-0">
      ...
      {/* CTA Section */}
      <section className="py-20 shuttle-gradient relative overflow-hidden">
        ...
        <div className="container mx-auto px-20 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Join hundreds of businesses that trust Softwaroid to protect their digital assets.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button className="bg-black hover:bg-gray-800 text-white px-8 py-3 button-glow">
                Contact Us Today
