          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-block mb-2 px-4 py-1 bg-black/5 backdrop-blur-sm rounded-full">
                <span className="text-sm font-medium text-black/70">Next-Gen Security Platform</span>
              </div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-6">
                Secure Your <br />
                <span className="relative">
                  <span className="relative z-10 text-primary-500">Digital Future</span>
        ...
        <div className="container mx-auto px-4 md:px-20 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              ...
              <div key={index} className="text-center p-6 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300 border border-gray-100">
